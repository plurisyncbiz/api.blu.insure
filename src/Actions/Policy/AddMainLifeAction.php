...
class AddMainLifeAction extends Action
{
    ...
    protected function action(): Response
    {
        ...
        $this->serials->changeStatus($body['activationid'], 'INPROGRESS_MAINLIFE');
        ...
        $validator
            ...
            ->add('date_of_birth', 'Under60', [
                ...
                'message' => 'You must be younger than 60 years old.'
            ]);
        ...
        if($errors){
            $this->serials->changeStatus($body['activationid'], 'ERRORS_MAINLIFE');
        ...
        if($body['date_of_birth']!=$id_values['dob']){
            $this->serials->changeStatus($body['activationid'], 'DOB_ID_MISMATCH_MAINLIFE');
        ...
        $this->serials->changeStatus($body['activationid'], 'MAINLIFE');

        //put in Action
        return $this->respondWithData($data, 200, 'Main Life Added');
    }
}