...
class AddSpouseLifeAction extends Action
{
    ...
    protected function action(): Response
    {
        ...
        //check if this is a valid activation
        $exists = $this->activations->exists($body['activationid']);
        if($exists===0){
            return $this->respondWithData(null, 400, 'This policy has not been activated');
        }
